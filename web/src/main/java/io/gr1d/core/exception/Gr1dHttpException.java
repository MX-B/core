 ...
 */
@Getter
public class Gr1dHttpException extends Exception {
    ...
    public Gr1dHttpException(final int httpStatus, final String message, final Object[] arguments) {
        this.httpStatus = httpStatus;
        this.message = message;
        this.arguments = arguments;
    }

    public Gr1dHttpException(final int httpStatus, final String message) {
        this.httpStatus = httpStatus;
        this.message = message;
