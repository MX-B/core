...
public enum DateTimes {
    ...
    public static ZonedDateTime startOfDay(final LocalDate date) {
        return date.atStartOfDay(UTC);
    }

    public static ZonedDateTime endOfDay(final LocalDate date) {
        return date.plusDays(1).atStartOfDay(UTC).minusNanos(1);
    }
